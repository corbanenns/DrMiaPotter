          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-8 border border-stone-light">
              ...
              <div className="mt-8 p-4 bg-sage-warm/10 rounded-lg border border-sage-warm/20">
                ...
                <p className="text-sm text-stone-medium">Please arrive 10 minutes early to complete any remaining paperwork. If you need to cancel or reschedule, please give us 24 hours notice otherwise you will be subject to the cancellation fee according the billing policy. </p>
              </div>
            </div>
          </div>
        </div>
