...
import { BreathingElement, StaggerContainer, StaggerItem } from "@/components/transitions/PageTransition";
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <StaggerItem>
              <BreathingElement intensity="subtle" className="bg-white/80 rounded-lg p-6 border border-stone-light gentle-glow">
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    <div className="font-playfair text-2xl font-bold text-sage-warm">Ages 1+</div>
          ...
          <div className="relative">
            <BreathingElement intensity="gentle" duration={8}>
